...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\columnwidth]{data/x_ray_summary_datas/x_ray_class_comparison.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\columnwidth]{data/x_ray_summary_datas/x_ray_confusion_matrix_normalized.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\columnwidth]{data/blood_cell_summary_datas/blood_cells_class_metrics.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\columnwidth]{data/agriculture/confusion_matrix_normalized.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\columnwidth]{data/blood_cell_summary_datas/blood_cells_PR_curve.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\columnwidth]{data/agriculture/labels.jpg}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\columnwidth]{data/x_ray_summary_datas/x_ray_results.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\columnwidth]{data/blood_cell_summary_datas/blood_cells_results.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\columnwidth]{data/agriculture/results.png}
